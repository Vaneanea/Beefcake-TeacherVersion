...
public class AttackPoint : MonoBehaviour
{
    ...
    public void attackTarget()
    {
        ...
        gm.GetComponentInChildren<BeefcakeManager>().GetPlayerBeefcake().transform.localPosition = PlayerPosition.position;
        ...
        currentHits -= gm.GetComponentInChildren<BeefcakeManager>().GetPlayerBeefcake().GetComponent<BeefcakeHolder>().GetAttackDamage();

        //reduce stamina
        gm.GetComponentInChildren<BeefcakeManager>().GetPlayerBeefcake().GetComponent<BeefcakeHolder>().ReduceStamina(1);
